const Preview = props => {
  return (
    <div className="preview">
      <a href="#">
        <iframe src={props.src} width="500px" height="300px" />
  ...
  render() {
    return (
      <div className="scorecard">
        <Head
          avatar="https://uploads.teamtreehouse.com/production/profile-photos/5686782/micro_massiveliam.jpg"
          user="William"
          date="July 23"
          desc="Small article about Lorem Ipshizzle"
        />{" "}
        <Preview
          src="https://www.google.de/"
          text="Lorem black that's the shizzle sit amet, brizzle adipiscing elizzle. Nullizzle pimpin' velizzle..."
